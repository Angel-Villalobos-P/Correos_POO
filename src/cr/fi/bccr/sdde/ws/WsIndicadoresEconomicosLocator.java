...
public class WsIndicadoresEconomicosLocator extends org.apache.axis.client.Service implements WsIndicadoresEconomicos {
    ...
    public WsIndicadoresEconomicosLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for wsIndicadoresEconomicosSoap
    private String wsIndicadoresEconomicosSoap_address = "https://gee.bccr.fi.cr/indicadoreseconomicos/WebServices/wsIndicadoresEconomicos.asmx";

    public String getwsIndicadoresEconomicosSoapAddress() {
        return wsIndicadoresEconomicosSoap_address;
    }

    // The WSDD service name defaults to the port name.
    private String wsIndicadoresEconomicosSoapWSDDServiceName = "wsIndicadoresEconomicosSoap";

    public String getwsIndicadoresEconomicosSoapWSDDServiceName() {
        return wsIndicadoresEconomicosSoapWSDDServiceName;
    }

    public void setwsIndicadoresEconomicosSoapWSDDServiceName(String name) {
    ...
    public WsIndicadoresEconomicosSoap getwsIndicadoresEconomicosSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cr.fi.bccr.sdde.ws.WsIndicadoresEconomicosSoapStub _stub = new cr.fi.bccr.sdde.ws.WsIndicadoresEconomicosSoapStub(portAddress, this);
    ...
    public void setwsIndicadoresEconomicosSoapEndpointAddress(String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (WsIndicadoresEconomicosSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                cr.fi.bccr.sdde.ws.WsIndicadoresEconomicosSoapStub _stub = new cr.fi.bccr.sdde.ws.WsIndicadoresEconomicosSoapStub(new java.net.URL(wsIndicadoresEconomicosSoap_address), this);
                _stub.setPortName(getwsIndicadoresEconomicosSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("wsIndicadoresEconomicosSoap".equals(inputPortName)) {
